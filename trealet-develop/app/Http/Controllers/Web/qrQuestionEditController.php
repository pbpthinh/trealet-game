...
class qrQuestionEditController extends Controller
{
    public function index()
    {
        $albums = $this->getAlbum();

        return view('trealets.qr-question-edit', compact('albums'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('trealets.qr-question-edit', compact('id', 'qrQuestion'));
    }
