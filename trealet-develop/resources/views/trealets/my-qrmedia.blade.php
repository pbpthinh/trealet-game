                                    ...
                                    <div class="d-flex">
                                        <div class="w-100">
                                            <div class="custom-control custom-radio" style = "text-align: center;" id="upload-form">
                                                <label class="upload-field upload-field-label" 
                                                ...
                                                <input type="file" class="form-control d-none upload-field-input"
                                                    id="upload-field" />
                                                <div class="upload-field-preview-container" id="file-preview-container" style="text-align: center;height: 300px; width: 50%; margin-left: 25%">
...
checkbox.addEventListener('change', (event) => {
  if (event.currentTarget.checked) {
    ...
    document.getElementById("upload-form").setAttribute("style", "display:block;text-align: center;");
  }
})
    </script>
<script>
...
function onDeleteStep(e) {
    ...
    if(index == 1){
        alert("Bạn ko thể xóa bước khởi đầu!");
        return;
    }
