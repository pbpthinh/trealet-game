    ...
    <div class="row pb-3 pt-2">
        @if (in_array('facebook', $socialProviders))
            <div class="col-{{ $colSize }} d-flex align-items-center justify-content-center">
                <a href="{{ url('auth/facebook/login?to=' . request('to')) }}" class="btn-facebook">
        ...
        @if (in_array('twitter', $socialProviders))
            <div class="col-{{ $colSize }} d-flex align-items-center justify-content-center">
                <a href="{{ url('auth/twitter/login?to=' . request('to')) }}" class="btn-twitter">
        ...
        @if (in_array('google', $socialProviders))
            <div class="col-{{ $colSize }} d-flex align-items-center justify-content-center">
                <a href="{{ url('auth/google/login?to=' . request('to')) }}" class="btn-google">
